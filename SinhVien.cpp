/*
D? ÁN PBL1: L?P TR?NH TÍNH TOÁN
Ch? đ?: Xây d?ng chương tr?nh qu?n l? sinh viên
...
void timKiemTheoTen(SinhVien a[], int n, char name[]) {
    int find = 0;
    for (int i = 0; i < n; i++) {
        // S? d?ng strstr đ? ki?m tra tên có xu?t hi?n trong tên sinh viên không
